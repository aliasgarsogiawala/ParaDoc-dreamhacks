  ...
  return (
    <div className="flex flex-col min-h-screen bg-white overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center px-4 py-2 bg-teal-50 rounded-full mb-8">
              ...
              <span className="text-sm font-medium text-teal-800">Revolutionizing Health Education</span>
            </div>
            ...
            <p className="text-xl text-gray-600 mb-10 max-w-2xl mx-auto">
              Interactive stories that educate, diagnose, and guide your healthcare decisions through immersive
              narratives tailored to your needs.
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Not just stories. <span className="text-teal-600">Health experiences.</span>
            </h2>
            <p className="text-xl text-gray-600">
              HealthLore combines cutting-edge AI with evidence-based healthcare knowledge to create personalized
              learning journeys.
            </p>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center mb-16">
            <div className="inline-flex items-center px-4 py-2 bg-white rounded-full mb-4">
              <span className="text-sm font-medium text-teal-800">Simple Process, Powerful Results</span>
            </div>
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">How HealthLore Works</h2>
            <p className="text-xl text-gray-600">Three simple steps to transform your health understanding</p>
          </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              See how HealthLore is changing the way people understand and manage their health
            </p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-teal-600 to-emerald-500 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl md:text-5xl font-bold text-white mb-6">Ready to transform your health journey?</h2>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400 mb-6">
                Making healthcare education and self-awareness addictive through interactive storytelling.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li>
                  <Link href="/stories" className="text-gray-400 hover:text-teal-400 transition-colors">
                    Health Stories
                  </Link>
                </li>
                <li>
                ...
                <li>
                  <Link href="/stories/create" className="text-gray-400 hover:text-teal-400 transition-colors">
                    Create Story
                  </Link>
                </li>
              </ul>
