...
export async function generateHealthTimelines(
  ...
  try {
    ...
    **SYMPTOM DESCRIPTION:**  
    ...
    1. Based on the complexity and ambiguity of the symptom described, generate **between 3 to 7 unique decision paths** a patient might realistically consider. Do not always assume 3. Simple symptoms might yield 2–3 paths, complex ones up to 7.
